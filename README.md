...
In my W1 MG1 breakdown, we identified four game objects: Player, Seeds, UI/Text, and Main Camera. This analysis directly shaped my Unity implementation.
  ...
  **1. Player Object:** My Player.cs script implements the Player's Position attribute as _playerTransform.position and Speed as _speed. 
...
Plant seeds [Space] is handled by PlantSeed().<br><br>
   ...
   **2. Seed Object:** The Seed's Position attribute becomes the plantPosition variable in PlantSeed(). 
...
The Be planted action uses Instantiate(_plantPrefab, plantPosition, Quaternion.identity).<br><br>
   ...
   **3. UI/Text Object:** My PlantCountUI.cs script on the UIManager GameObject manages two TextMeshPro texts: _remainingText (seeds left) and _plantedText (seeds planted). 
